...
void	Bureaucrat::signForm(AForm &form)
{
	...
	{
		form.beSigned(*this);
		std::cout << std::endl << "\033[32m✅ " << this->_name << " signed " << form.getName() << "\033[0m" << std::endl << std::endl;
	}
	catch (const std::exception &e)
	{
		std::cout << std::endl << "\033[1;31m🆘 " << this->_name << " couldn't sign " << form.getName() << " because " << e.what() << "\033[0m" << std::endl << std::endl;
	}
}
